...
typedef struct stKCFunctions {
	...
	unsigned long(*X509ValidateCertificate)(char *inCert, int inCertLength, int validType, char *validPath, long long checkTime, char *outInfo, int *outInfoLength, int flag, char *getOCSPResponse, int *getOCSPResponseLenght);
